...
urlpatterns = [
    ...
    path('view-order-details/<customer_id>/<order>/', ViewOrder.as_view(), name="view-order-details"),
    path('cancel-order-via-customer/<int:customer_id>/<str:order_number>/', CancelOrderViaCustomer.as_view(), name='cancel-order'),
    path('cancel-order-via-dealer/<dealer_id>/<order_number>/', CancelOrderViadealer.as_view(), name="view-order-details"),
    path('accepted-order-via-dealer/<dealer_id>/<order_number>/', AcceptedOrderViadealer.as_view(), name="view-order-details"),
    path('get-all-orders-customer/<customer_id>/', GetAllOrdersCustomer.as_view(), name="get-all-orders-customer"),
    path('get-all-orders-dealer/<dealer_id>/', GetAllOrdersdealer.as_view(), name="get-all-orders-dealer"),
    path('get-order-product/<order>/', GetOrderProducuts.as_view(), name="get-order-product"),
    path('get-all-orders-of-customer-for-dealer/<order_number>/', GetAllOrdersofCustomerfordealer.as_view(), name="get-all-orders-of-customer-for-dealer"),
