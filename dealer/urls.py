...
urlpatterns = [
    ...
    path('api/getdealers/<int:pincode>', views.getdealer, name="get-dealer-by-pincode"),
    #path('api/getdealers/', views.Getdealers.as_view(), name="get-dealer-by-lon-lat"),
    path('api/requestinquiry-get/<dealer_id>/', views.RequestInquiryGet.as_view(), name='requestinquiry-get'),
